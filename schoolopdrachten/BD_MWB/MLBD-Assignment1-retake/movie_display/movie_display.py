...
</div>""".format('https://www.imdb.com/title/tt0' + str(item.imdbId), item.Title, str(item.Year), item.Genre, str(item.imdbRating), item.Plot, item.Poster, str((float(item.imdbRating) / 10.0) * 140.0))
